<main data-halaman-aktif="formLayout" x-data="{pageName: `Form Layouts`, breadcrumbs : ['Form', 'Layouts']}">
                            ...
                            <div class="-mx-2.5 flex flex-wrap gap-y-5">
                                ...
                                <div class="w-full px-2.5">
                                    <div
                                            ...
                                            <label
                                                ...
                                                <div class="relative">
                                                    ...
                                                    <div
                                                        ...
                                                        <span
                                                            :class="checkboxToggle ? '' : 'opacity-0'">
                                                            <svg
                                                                width="14"
                                                                height="14"
                                                                viewBox="0 0 14 14"
                                        ...
                                        <button
                                            type="submit"
                                            class="flex items-center justify-center w-full gap-2 px-4 py-3 text-sm font-medium text-white rounded-lg bg-brand-500 hover:bg-brand-600 xl:w-auto">
                                            Create Account
                                ...
                                <div class="w-full px-2.5">
                                    <div
                                        ...
                                        <div class="flex flex-wrap items-center gap-4">
                                            <div>
                                                <label
                                                    :class="isChecked === 'Free' ? 'text-gray-700 dark:text-gray-400' : 'text-gray-500 dark:text-gray-400'"
                                                    ...
                                                    <span
                                                        :class="isChecked === 'Free' ? 'border-brand-500 bg-brand-500' : 'bg-transparent border-gray-300 dark:border-gray-700'"
                                                        class="flex h-5 w-5 items-center justify-center rounded-full border-[1.25px]">
                                                        <span
                                                            :class="isChecked === 'Free' ? 'block' : 'hidden'"
                                            ...
                                            <div>
                                                <label
                                                    :class="isChecked === 'Paid' ? 'text-gray-700 dark:text-gray-400' : 'text-gray-500 dark:text-gray-400'"
                                                    class="relative flex items-center gap-3 text-sm font-medium cursor-pointer select-none">
                                                    <input
                                                        class="sr-only"
                                                        type="radio"
                                                    ...
                                                    <span
                                                        :class="isChecked === 'Paid' ? 'border-brand-500 bg-brand-500' : 'bg-transparent border-gray-300 dark:border-gray-700'"
                                                        class="flex h-5 w-5 items-center justify-center rounded-full border-[1.25px]">
                                                        <span
                                                            :class="isChecked === 'Paid' ? 'block' : 'hidden'"
                                                            class="w-2 h-2 bg-white rounded-full"></span>
                                                    </span>
                                                    Paid
                                                </label>
