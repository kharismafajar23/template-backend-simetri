    ...
    <table class="w-full">
      ...
      <tbody>
        <tr class="border-t border-gray-100 dark:border-gray-800">
          ...
          <td class="px-6 py-3.5">
            <div class="w-5 h-5 overflow-hidden rounded-full">
              <img src="./assets/images/country/country-01.svg" alt="country" />
            </div>
          </td>
          <td class="px-6 py-3.5">
        ...
        <tr class="border-t border-gray-100 dark:border-gray-800">
          ...
          <td class="px-6 py-3.5">
            <div class="w-5 h-5 overflow-hidden rounded-full">
              <img src="./assets/images/country/country-03.svg" alt="country" />
            </div>
          </td>
          <td class="px-6 py-3.5">
            <p class="text-gray-500 text-theme-sm dark:text-gray-400">
        ...
        <tr class="border-t border-gray-100 dark:border-gray-800">
          ...
          <td class="px-6 py-3.5">
            <div class="w-5 h-5 overflow-hidden rounded-full">
              <img src="./assets/images/country/country-04.svg" alt="country" />
            </div>
          </td>
          <td class="px-6 py-3.5">
            <p class="text-gray-500 text-theme-sm dark:text-gray-400">
        ...
        <tr class="border-t border-gray-100 dark:border-gray-800">
          ...
          <td class="px-6 py-3.5">
            <div class="w-5 h-5 overflow-hidden rounded-full">
              <img src="./assets/images/country/country-05.svg" alt="country" />
            </div>
          </td>
          <td class="px-6 py-3.5">
            <p class="text-gray-500 text-theme-sm dark:text-gray-400">
        ...
        <tr class="border-t border-gray-100 dark:border-gray-800">
          ...
          <td class="px-6 py-3.5">
            <div class="w-5 h-5 overflow-hidden rounded-full">
              <img src="./assets/images/country/country-06.svg" alt="country" />
            </div>
          </td>
          <td class="px-6 py-3.5">
            <p class="text-gray-500 text-theme-sm dark:text-gray-400">
        ...
        <tr class="border-t border-gray-100 dark:border-gray-800">
          ...
          <td class="px-6 py-3.5">
            <div class="w-5 h-5 overflow-hidden rounded-full">
              <img src="./assets/images/country/country-07.svg" alt="country" />
            </div>
          </td>
          <td class="px-6 py-3.5">
            <p class="text-gray-500 text-theme-sm dark:text-gray-400">
        ...
        <tr class="border-t border-gray-100 dark:border-gray-800">
          ...
          <td class="px-6 py-3.5">
            <div class="w-5 h-5 overflow-hidden rounded-full">
              <img src="./assets/images/country/country-08.svg" alt="country" />
            </div>
          </td>
          <td class="px-6 py-3.5">
            <p class="text-gray-500 text-theme-sm dark:text-gray-400">
