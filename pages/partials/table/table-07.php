<div
  ...
  <div class="max-w-full overflow-x-auto">
    <div class="min-w-[1026px]">
      <!-- table header start -->
      <div
        class="grid grid-cols-11 border-t border-gray-200 px-6 py-3 dark:border-gray-800">
      ...
      <div
        ...
        <div class="col-span-3 flex items-center">
          <div
            ...
            <div>
              <img
                src="./assets/images/icons/file-video.svg"
                alt="icon"
                class="dark:hidden" />
              <img
                src="./assets/images/icons/file-video-dark.svg"
                alt="icon"
      ...
      <div
        ...
        <div class="col-span-3 flex items-center">
          <div
            ...
            <div>
              <img
                src="./assets/images/icons/file-image.svg"
                alt="icon"
                class="dark:hidden" />
              <img
                src="./assets/images/icons/file-image-dark.svg"
                alt="icon"
                class="hidden dark:block" />
            </div>
      ...
      <div
        ...
        <div class="col-span-3 flex items-center">
          <div
            ...
            <div>
              <img
                src="./assets/images/icons/file-pdf.svg"
                alt="icon"
                class="dark:hidden" />
              <img
                src="./assets/images/icons/file-pdf-dark.svg"
                alt="icon"
                class="hidden dark:block" />
            </div>
