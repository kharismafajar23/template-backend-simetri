          ...
          <td class="py-3 whitespace-nowrap">
            <div class="col-span-3 flex items-center">
              <div class="flex items-center gap-3">
                <div class="h-8 w-8">
                  <img src="./assets/images/brand/brand-08.svg" alt="brand" />
                </div>
        ...
        <tr>
          <td class="py-3 whitespace-nowrap">
            <div class="flex items-center">
              <div class="flex items-center gap-3">
                <div class="h-8 w-8">
                  <img src="./assets/images/brand/brand-07.svg" alt="brand" />
                </div>
        ...
        <tr>
          <td class="py-3 whitespace-nowrap">
            <div class="flex items-center">
              <div class="flex items-center gap-3">
                <div class="h-8 w-8">
                  <img src="./assets/images/brand/brand-15.svg" alt="brand" />
                </div>
            ...
            <div class="flex items-center justify-center">
              <div x-data="{openDropDown: false}" class="relative">
                ...
                <div
                  x-show="openDropDown"
                  @click.outside="openDropDown = false"
                  class="shadow-theme-lg dark:bg-gray-dark absolute right-0 bottom-full z-40 w-40 space-y-1 rounded-2xl border border-gray-200 bg-white p-2 dark:border-gray-800">
                  <button
                    class="text-theme-xs flex w-full rounded-lg px-3 py-2 text-left font-medium text-gray-500 hover:bg-gray-100 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-gray-300">
                    View More
                  </button>
        ...
        <tr>
          <td class="py-3 whitespace-nowrap">
            <div class="flex items-center">
              <div class="flex items-center gap-3">
                <div class="h-8 w-8">
                  <img src="./assets/images/brand/brand-10.svg" alt="brand" />
                </div>
