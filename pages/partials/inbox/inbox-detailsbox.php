<div
  ...
  <div
    ...
    <div
      class="flex w-full items-center justify-between gap-3 px-4 py-4 sm:justify-normal">
      <button
    ...
    <div
      class="flex w-full items-center justify-between gap-4 border-t border-gray-200 px-4 py-3 dark:border-gray-800 sm:justify-end sm:border-t-0 sm:py-5">
  ...
  <div class="h-screen overflow-y-auto">
    <div
      class="custom-scrollbar block h-full max-h-full overflow-auto p-5 xl:p-6">
      <div class="mb-9 flex items-center gap-3">
        <div class="h-12 w-12 overflow-hidden rounded-full">
          <img src="./assets/images/user/user-18.jpg" alt="user" />
        </div>

        <div>
          <span
            class="mb-0.5 block text-sm font-medium text-gray-800 dark:text-white/90">
      ...
      <div class="mb-7 text-sm text-gray-500 dark:text-gray-400">
        ...
        <p class="mb-4">
          ...
          rutrum mi. Aenean ac leo non justo suscipit consectetur. Nam
        ...
        <p class="mb-4">
          ...
          Nam vestibulum eleifend magna quis porta.
        </p>
        ...
        <p class="mb-4">
          ...
          ornare massa. odales diam, quis rhoncus dolor aliquet a. Nulla a
          rhoncus lectus. In nunc neque
        </p>
        ...
        <p class="mb-4">
          Nullam tincidunt sodales diam, quis rhoncus dolor aliquet a. Nulla a
          rhoncus lectus. In nunc neque, pellentesque non massa ornare, accumsan
          ornare massa. sodales diam, quis rhoncus dolor aliquet a. Nulla a
          rhoncus lectus. In nunc neque
        </p>
        ...
        <div class="flex flex-col items-center gap-3 sm:flex-row">
          <div
            ...
            <div class="h-10 w-full max-w-10">
              <img src="./assets/images/task/pdf.svg" alt="icon" />
            </div>
            <div>
              ...
              <span class="flex items-center gap-1.5">
                ...
                <span
                  class="inline-block h-1 w-1 rounded-full bg-gray-400"></span>
                <span class="text-theme-xs text-gray-500 dark:text-gray-400">
                  Download
                </span>
              </span>
          ...
          <div
            class="relative flex w-full cursor-pointer items-center gap-3 rounded-xl border border-gray-200 bg-white py-2.5 pl-3 pr-5 dark:border-gray-800 dark:bg-white/5 sm:w-auto">
            <div class="h-10 w-full max-w-10">
              <img src="./assets/images/task/google-drive.svg" alt="icon" />
            </div>
            <div>
              <p class="text-sm font-medium text-gray-800 dark:text-white/90">
                Branding Assets
  ...
  <div
    class="sticky bottom-0 border-t border-gray-200 bg-white p-4 dark:border-gray-800 dark:bg-[#171f2f]">
    <div class="flex items-center gap-3">
      <button
