  ...
  <div class="flex h-[372px] flex-col">
    <div class="custom-scrollbar flex h-auto flex-col overflow-y-auto pr-3">
      ...
      <div
        ...
        <div class="flex items-center gap-3">
          <div class="h-10 w-10">
            <img src="./assets/images/brand/brand-12.svg" alt="brand" />
          </div>
      ...
      <div
        ...
        <div class="flex items-center gap-3">
          <div class="h-10 w-10">
            <img src="./assets/images/brand/brand-13.svg" alt="brand" />
          </div>
      ...
      <div
        ...
        <div class="flex items-center gap-3">
          <div class="h-10 w-10">
            <img src="./assets/images/brand/brand-14.svg" alt="brand" />
          </div>
