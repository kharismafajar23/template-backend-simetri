<div
  ...
  <div>
    <div
      ...
      <div class="flex items-center gap-4">
        <div class="w-full max-w-8 items-center rounded-full">
          <img src="./assets/images/brand/brand-05.svg" alt="brand" />
        </div>
        <div>
    ...
    <div
      ...
      <div class="flex items-center gap-4">
        <div class="w-full max-w-8 items-center rounded-full">
          <img src="./assets/images/brand/brand-06.svg" alt="brand" />
        </div>
        <div>
          <p class="text-theme-sm font-medium text-gray-700 dark:text-gray-300">
            Youtube
      ...
      <div class="flex w-full max-w-[140px] items-center gap-3">
        <div
          class="relative block h-2 w-full max-w-[100px] rounded-sm bg-gray-200 dark:bg-gray-800">
          <div
            class="absolute left-0 top-0 flex h-full w-[55%] items-center justify-center rounded-sm bg-brand-500 text-xs font-medium text-white"></div>
        </div>
        <p class="text-theme-sm font-medium text-gray-700 dark:text-gray-400">
          55%
        </p>
    ...
    <div
      ...
      <div class="flex w-full max-w-[140px] items-center gap-3">
        <div
          class="relative block h-2 w-full max-w-[100px] rounded-sm bg-gray-200 dark:bg-gray-800">
          <div
            class="absolute left-0 top-0 flex h-full w-[48%] items-center justify-center rounded-sm bg-brand-500 text-xs font-medium text-white"></div>
        </div>
        <p class="text-theme-sm font-medium text-gray-700 dark:text-gray-400">
          48%
        </p>
