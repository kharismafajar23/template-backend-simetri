<div
  @click.outside="isMobile = !isMobile"
  class="flex-col rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03] xl:flex xl:w-1/4">
  <!-- ====== Chat List Start -->
  <div class="sticky px-4 pb-4 pt-4 sm:px-5 sm:pt-5 xl:pb-0">
    <div class="flex items-start justify-between">
      <div>
        <h3
          class="text-theme-xl font-semibold text-gray-800 dark:text-white/90 sm:text-2xl">
          Chats
        </h3>
      </div>
  ...
  <div
    class="no-scrollbar flex-col overflow-auto"
    ...
    <div class="flex max-h-full flex-col overflow-auto px-4 sm:px-5">
      <div class="custom-scrollbar max-h-full space-y-1 overflow-auto">
          ...
          <div class="w-full">
            <div class="flex items-start justify-between">
              <div>
                ...
                <p
                  class="mt-0.5 text-theme-xs text-gray-500 dark:text-gray-400">
                  Project Manager
                </p>
              </div>
        ...
        <div
          ...
          <div class="relative h-12 w-full max-w-[48px] rounded-full">
            <img
              ...
              class="h-full w-full overflow-hidden rounded-full object-cover object-center" />
            <span
              class="absolute bottom-0 right-0 block h-3 w-3 rounded-full border-[1.5px] border-white bg-warning-500 dark:border-gray-900"></span>
          </div>
          <div class="w-full">
            <div class="flex items-start justify-between">
              <div>
        ...
        <div
          ...
          <div class="relative h-12 w-full max-w-[48px] rounded-full">
            <img
              ...
              class="h-full w-full overflow-hidden rounded-full object-cover object-center" />
            <span
              class="absolute bottom-0 right-0 block h-3 w-3 rounded-full border-[1.5px] border-white bg-error-500 dark:border-gray-900"></span>
          </div>
          <div class="w-full">
            <div class="flex items-start justify-between">
              <div>
        ...
        <div
          ...
          <div class="relative h-12 w-full max-w-[48px] rounded-full">
            <img
              src="./assets/images/user/user-37.jpg"
              alt="profile"
              class="h-full w-full overflow-hidden rounded-full object-cover object-center" />
            <span
              class="absolute bottom-0 right-0 block h-3 w-3 rounded-full border-[1.5px] border-white bg-success-500 dark:border-gray-900"></span>
