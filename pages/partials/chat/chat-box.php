  ...
  <div
    ...
    <div class="max-w-[350px]">
      <div class="flex items-start gap-4">
        ...
        <div>
          <div
            class="rounded-lg rounded-tl-sm bg-gray-100 px-3 py-2 dark:bg-white/5">
    ...
    <div class="ml-auto max-w-[350px] text-right">
      <div
        class="ml-auto max-w-max rounded-lg rounded-tr-sm bg-brand-500 px-3 py-2 dark:bg-brand-500">
    ...
    <div class="ml-auto max-w-[350px] text-right">
      <div
        class="ml-auto max-w-max rounded-lg rounded-tr-sm bg-brand-500 px-3 py-2 dark:bg-brand-500 dark:text-white/90">
        <p class="text-sm text-white dark:text-white/90">
          If don’t like something, I’ll stay away from it.
        </p>
      </div>
      ...
      <div
        class="ml-auto mt-2 max-w-max rounded-lg rounded-tr-sm bg-brand-500 px-3 py-2 dark:bg-brand-500">
        <p class="text-sm text-white dark:text-white/90">
      ...
      <div class="flex items-start gap-4">
        ...
        <div>
          <div class="mb-2 w-full max-w-[270px] overflow-hidden rounded-lg">
            <img src="./assets/images/chat/chat.jpg" alt="chat" />
          </div>
          <div
            class="max-w-max rounded-lg rounded-tl-sm bg-gray-100 px-3 py-2 dark:bg-white/5">
            <p class="text-sm text-gray-800 dark:text-white/90">
