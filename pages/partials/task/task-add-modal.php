            ...
            <div
              ...
              <div>
                ...
                <span class="flex items-center gap-1.5">
                  ...
                  <span
                    class="inline-block w-1 h-1 bg-gray-400 rounded-full"></span>
                  <span class="text-gray-500 text-theme-xs dark:text-gray-400">
                    Download
                  </span>
                </span>
...
<!-- class="fixed left-0 top-0 z-99999 flex h-screen w-full justify-center overflow-y-auto overflow-x-hidden bg-gray-400/50 px-2 py-4 backdrop-blur-[32px] lg:py-[120px]" -->