<div class="grid grid-cols-1 gap-5 sm:grid-cols-2 xl:grid-cols-3">
  ...
  <div>
    <div
      ...
      <div class="mb-5 overflow-hidden rounded-lg">
        <img
          src="./assets/images/cards/card-01.png"
          alt="card"
  ...
  <div>
    <div
      ...
      <div class="mb-5 overflow-hidden rounded-lg">
        <img
          src="./assets/images/cards/card-02.png"
          alt="card"
          class="overflow-hidden rounded-lg" />
      </div>
  ...
  <div>
    <div
      ...
      <div class="mb-5 overflow-hidden rounded-lg">
        <img
          src="./assets/images/cards/card-03.png"
          alt="card"
          class="overflow-hidden rounded-lg" />
      </div>
      ...
      <div>
        ...
        <a
          href="#"
          class="mt-4 inline-flex items-center gap-1 text-sm text-brand-500 hover:text-brand-600">
          <svg
            class="fill-current"
            width="16"
            height="16"
