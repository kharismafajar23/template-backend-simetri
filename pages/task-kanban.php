<main data-halaman-aktif="taskKanban" x-data="{pageName: `Kanban`, breadcrumbs: ['Task', 'Kanban'], 'isTaskModalModal': false}">
        ...
        <div class="swim-lane flex flex-col gap-5 p-4 xl:p-6">
          ...
          <div
            ...
            <div class="flex items-start justify-between gap-6">
              ...
              <div
                class="h-6 w-full max-w-6 overflow-hidden rounded-full border-[0.5px] border-gray-200 dark:border-gray-800">
                <img src="./assets/images/user/user-07.jpg" alt="user" />
              </div>
            </div>
          </div>
          ...
          <div
            ...
            <div class="flex items-start justify-between gap-6">
              ...
              <div
                class="h-6 w-full max-w-6 overflow-hidden rounded-full border-[0.5px] border-gray-200 dark:border-gray-800">
                <img src="./assets/images/user/user-08.jpg" alt="user" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div
          ...
          <div
            ...
            <div class="flex items-start justify-between gap-6">
              ...
              <div
                class="h-6 w-full max-w-6 overflow-hidden rounded-full border-[0.5px] border-gray-200 dark:border-gray-800">
                <img src="./assets/images/user/user-09.jpg" alt="user" />
              </div>
            </div>
          </div>
          ...
          <div
            ...
            <div class="flex items-start justify-between gap-6">
              ...
              <div
                class="h-6 w-full max-w-6 overflow-hidden rounded-full border-[0.5px] border-gray-200 dark:border-gray-800">
                <img src="./assets/images/user/user-10.jpg" alt="user" />
              </div>
            </div>
          </div>
          ...
          <div
            ...
            <div>
              ...
              <div class="my-4">
                <img
                  src="./assets/images/task/task.png"
                  alt="task"
              ...
              <div class="flex items-start justify-between gap-6">
                ...
                <div
                  class="h-6 w-full max-w-6 overflow-hidden rounded-full border-[0.5px] border-gray-200 dark:border-gray-800">
                  <img src="./assets/images/user/user-11.jpg" alt="user" />
                </div>
              </div>
            </div>
          </div>
          ...
          <div
            ...
            <div class="flex items-start justify-between gap-6">
              ...
              <div
                class="h-6 w-full max-w-6 overflow-hidden rounded-full border-[0.5px] border-gray-200 dark:border-gray-800">
                <img src="./assets/images/user/user-12.jpg" alt="user" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="swim-lane flex flex-col gap-5 p-4 xl:p-6">
          ...
          <div
            ...
            <div class="flex items-start justify-between gap-6">
              ...
              <div
                class="h-6 w-full max-w-6 overflow-hidden rounded-full border-[0.5px] border-gray-200 dark:border-gray-800">
                <img src="./assets/images/user/user-13.jpg" alt="user" />
              </div>
            </div>
          </div>
          ...
          <div
            ...
            <div class="flex items-start justify-between gap-6">
              ...
              <div
                class="h-6 w-full max-w-6 overflow-hidden rounded-full border-[0.5px] border-gray-200 dark:border-gray-800">
                <img src="./assets/images/user/user-14.jpg" alt="user" />
              </div>
            </div>
          </div>
          ...
          <div
            ...
            <div class="flex items-start justify-between gap-6">
              ...
              <div
                class="h-6 w-full max-w-6 overflow-hidden rounded-full border-[0.5px] border-gray-200 dark:border-gray-800">
                <img src="./assets/images/user/user-15.jpg" alt="user" />
              </div>
            </div>
          </div>
          ...
          <div
            ...
            <div class="flex items-start justify-between gap-6">
              ...
              <div
                class="h-6 w-full max-w-6 overflow-hidden rounded-full border-[0.5px] border-gray-200 dark:border-gray-800">
                <img src="./assets/images/user/user-16.jpg" alt="user" />
              </div>
            </div>
          </div>
        </div>
